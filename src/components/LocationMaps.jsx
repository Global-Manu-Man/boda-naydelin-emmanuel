...
const LocationMaps = () => {
  return (
    <div className="mb-12 sm:mb-16 px-2 sm:px-0">
      <h2 className="text-3xl sm:text-4xl text-center mb-8 sm:mb-12" style={{
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        ...
        {/* Ceremony Map */}
        <div className="rounded-2xl overflow-hidden shadow-xl border-2" style={{ 
          borderColor: '#e8d5c4',
          background: 'white'
        }}>
          {/* Header */}
          <div className="p-6 text-center" style={{
            background: 'linear-gradient(135deg, rgba(245,241,237,0.9) 0%, rgba(232,213,196,0.6) 100%)'
          }}>
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full mb-3" style={{
      ...
      <div className="mt-8 text-center max-w-2xl mx-auto px-4">
        <div className="p-6 rounded-xl border-2" style={{
          ...
          <p className="text-sm leading-relaxed" style={{
            ...
            💡 <span className="font-semibold">Tip:</span> Haz clic en "Abrir en Google Maps" para obtener direcciones desde tu ubicación actual.
            Te recomendamos salir con anticipación para evitar contratiempos.
          </p>
        </div>
      </div>
    </div>
